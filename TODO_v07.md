...
- [ ] **[P0][Order 01] P0-T1 Freeze v0.7 scope contract and anti-scope boundaries**
  ...
  - **Concrete actions:**
    - [ ] **P0-T1-ST1 Build v0.7 scope trace base 9 bullets to task IDs**
...
- [ ] **[P0][Order 07] P2-T1 Define history sync protocol surfaces and lifecycle contract**
  ...
  - **Concrete actions:**
    ...
    - [ ] **P2-T1-ST3 Define mode-epoch segmentation and history migration signaling (SecurityMode transitions)**
...
| S7-09 | History migration across security-mode epochs optional re-encryption History Capsule workflow | P2-T1 P2-T2 P2-T3 | VA-H1 VA-H2 VA-H3 VA-H4 VA-H7 VA-I1 | P2-T1 P2-T2 P2-T3 acceptance + P5-T1 scenario coverage |
...
- [ ] All 9 v0.7 roadmap bullets are mapped to tasks artifacts and acceptance anchors.
...
- [ ] Cross-feature positive negative degraded recovery scenarios cover all nine scope bullets.
