...
### 4. E2EE Architecture (Unchanged from v1, Summarized)

- **DMs:** Full Signal Protocol (X3DH + Double Ratchet).
- **Group DMs (≤50):** Signal Sender Keys.
- **Channels (>50):** Sender Keys with TreeKEM-inspired key distribution for efficient rotation.
- **Voice/Video/Screen:** SFrame per-participant encryption. Keys distributed via channel's Sender Key mechanism.
