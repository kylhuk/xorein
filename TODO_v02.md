...
> Status: Execution artifact. `pkg/v02` contracts, tests, and phase gate docs now exist; this TODO tracks final verification evidence.
>
...
>
> Evidence: `docs/v0.2/phase0/p0-t1-scope-contract.md`, `docs/v0.2/phase7/p7-t3-release-gate-handoff.md`, `pkg/v02`.
...
- Security-mode labeling baseline for v0.2 conversation surfaces (DM = E2EE (Seal), Group DM = E2EE (Tree)) with explicit disclosure (no silent downgrade)
...
- [x] **[P0][Order 01] P0-T1 Freeze v0.2 scope contract and traceability map**
  - **Artifact references:** `docs/v0.2/phase0/p0-t1-scope-contract.md`
  - **Objective:** Convert v0.2 roadmap bullets into an approved scope contract with one-to-one task traceability.
  - **Concrete actions:**
    - [x] **P0-T1-ST1 Create v0.2 scope-to-roadmap trace table**
    ...
    - [x] **P0-T1-ST2 Define v0.2 explicit non-goals and overlap boundaries**
...
- [x] **[P0][Order 02] P0-T2 Lock protocol compatibility and governance checklist for v0.2**
  - **Artifact references:** `docs/v0.2/phase0/p0-t2-compatibility-governance-checklist.md`
  - **Objective:** Ensure all v0.2 protocol changes remain compliant with compatibility and governance constraints.
  - **Concrete actions:**
    - [x] **P0-T2-ST1 Create protobuf evolution checklist for v0.2 changes**
    ...
    - [x] **P0-T2-ST2 Define major-change trigger and downgrade negotiation checklist**
...
- [x] **[P0][Order 03] P0-T3 Establish v0.2 verification matrix and evidence format**
  - **Artifact references:** `docs/v0.2/phase0/p0-t3-verification-evidence-matrix.md`
  - **Objective:** Predefine what evidence is required to mark each v0.2 task complete.
  - **Concrete actions:**
    - [x] **P0-T3-ST1 Define requirement-to-test matrix for all v0.2 scope items**
    ...
    - [x] **P0-T3-ST2 Define evidence artifact schema for completion reviews**
...
- [x] **[P0][Order 04] P1-T1 Define DM protocol surfaces: IDs, schemas, capability negotiation**
  - **Artifact references:** `docs/v0.2/phase1/p1-t1-dm-protocol-surfaces.md`
  - **Objective:** Formalize all protocol interfaces required for 1:1 DM in v0.2.
  - **Concrete actions:**
    - [x] **P1-T1-ST1 Register DM-related protocol identifiers and versioning plan**
    ...
    - [x] **P1-T1-ST2 Extend protobuf schemas for DM handshake and payload envelopes**
    ...
    - [x] **P1-T1-ST3 Add `SecurityMode` and `mode_epoch_id` to DM metadata + capability negotiation (v0.2 baseline: Seal/Tree)**
      - **Objective:** Establish a scaling-aware security-mode surface early so later channel modes (Crowd/Channel/Clear) can evolve without breaking v0.2 contracts.
      - **Concrete actions:** Extend DM and Group DM metadata/envelopes with `security_mode` and `mode_epoch_id`; define negotiation rules and explicit downgrade/unsupported-mode outcomes.
      - **Dependencies/prerequisites:** P1-T1-ST2.
      - **Deliverables/artifacts:** v0.2 SecurityMode schema additions and negotiation notes.
      - **Acceptance criteria:** DM and Group DM sessions expose an explicit security-mode label and epoch identifier; unsupported modes fail with deterministic reason codes (no silent downgrade).
      - **Suggested priority/order:** P0, Order 04.3.
      - **Risks/notes:** Adding mode later without an early field tends to cause ad-hoc, incompatible overlays.
...
- [x] **[P0][Order 05] P1-T2 Specify X3DH key agreement profile for v0.2 DMs**
  - **Artifact references:** `docs/v0.2/phase1/p1-t2-x3dh-profile.md`
  - **Objective:** Define exact X3DH operational profile and key lifecycle behavior.
  - **Concrete actions:**
    - [x] **P1-T2-ST1 Define key material model and prekey classes**
    ...
    - [x] **P1-T2-ST2 Define X3DH handshake sequence and failure taxonomy**
...
- [x] **[P0][Order 06] P1-T3 Specify Double Ratchet session model and cryptographic validation set**
  - **Artifact references:** `docs/v0.2/phase1/p1-t3-double-ratchet-validation-pack.md`
  - **Objective:** Define robust DM session cryptography for normal and failure paths.
  - **Concrete actions:**
    - [x] **P1-T3-ST1 Define ratchet state persistence and out-of-order handling rules**
    ...
    - [x] **P1-T3-ST2 Define cryptographic test vectors and adversarial test requirements**
...
- [x] **[P0][Order 07] P2-T1 Define DHT prekey bundle publication and retrieval lifecycle**
  - **Artifact references:** `docs/v0.2/phase2/p2-dm-transport-baseline.md`
  - **Objective:** Ensure discoverable, verifiable, and rotatable prekey material in DHT.
  - **Concrete actions:**
    - [x] **P2-T1-ST1 Define prekey bundle record schema, signatures, and expiry metadata**
    ...
    - [x] **P2-T1-ST2 Define rotation, depletion, and republish rules for prekey inventories**
...
- [x] **[P0][Order 08] P2-T2 Define direct DM transport and negotiation behavior**
  - **Artifact references:** `docs/v0.2/phase2/p2-dm-transport-baseline.md`
  - **Objective:** Establish low-latency direct delivery path for online peers.
  - **Concrete actions:**
    - [x] **P2-T2-ST1 Define direct stream open/close and session-binding semantics**
    ...
    - [x] **P2-T2-ST2 Define encrypted envelope metadata minimization and integrity checks**
...
- [x] **[P0][Order 09] P2-T3 Define offline DM store-and-forward path via DHT with delivery guarantees**
  - **Artifact references:** `docs/v0.2/phase2/p2-dm-transport-baseline.md`
  - **Objective:** Provide reliable DM delivery when recipient is offline.
  - **Concrete actions:**
    - [x] **P2-T3-ST1 Define mailbox addressing, ciphertext storage, and TTL/replication policy**
    ...
    - [x] **P2-T3-ST2 Define ack/retry/idempotency semantics for offline retrieval**
...
- [x] **[P0][Order 10] P3-T1 Define Group DM domain model and membership lifecycle**
  - **Artifact references:** `docs/v0.2/phase3/p3-group-dm-baseline.md`
  - **Objective:** Standardize Group DM creation, membership, and state transitions.
  - **Concrete actions:**
    - [x] **P3-T1-ST1 Define create/invite/join/leave/remove state machine**
    ...
    - [x] **P3-T1-ST2 Define membership event schema and ordering guarantees**
...
- [x] **[P0][Order 11] P3-T2 Define Group DM MLS distribution and rotation rules (with Sender Keys compatibility bridge)**
  - **Artifact references:** `docs/v0.2/phase3/p3-group-dm-baseline.md`
  - **Objective:** Preserve confidentiality and forward secrecy behavior in group contexts.
  - **Concrete actions:**
    - [x] **P3-T2-ST1 Define initial Sender Key distribution and secure handoff**
    ...
    - [x] **P3-T2-ST2 Define rekey triggers for membership changes and compromise response**
...
- [x] **[P0][Order 12] P3-T3 Define Group DM transport, history behavior, and member-cap enforcement**
  - **Artifact references:** `docs/v0.2/phase3/p3-group-dm-baseline.md`
  - **Objective:** Provide stable message flow and bounded scale for Group DMs.
  - **Concrete actions:**
    - [x] **P3-T3-ST1 Define message routing, offline retrieval, and history sync boundaries**
      - **Objective:** Keep Group DM behavior aligned with direct/offline DM transport semantics.
      - **Concrete actions:** Specify fetch windows, sync triggers, **history visibility policy for new joiners (default: from join time)**, and error handling for missing/locked history.
      - **Dependencies/prerequisites:** P2-T3, P3-T1.
      - **Deliverables/artifacts:** Group DM transport and history policy.
      - **Acceptance criteria:** History and transport semantics are deterministic and bounded, including explicit “locked history” outcomes for viewers lacking prior epoch keys.
      - **Suggested priority/order:** P1, Order 12.1.
      - **Risks/notes:** Unbounded sync can degrade client performance.
    - [x] **P3-T3-ST2 Enforce and validate 50-member cap with explicit rejection behavior**
      - **Objective:** Keep v0.2 within planned scale envelope.
      - **Concrete actions:** Define enforcement checks, **pre-cap warning threshold (e.g., 80% of cap)**, and user-facing rejection reasons for limit breaches, including a guided “convert to server/channel” option.
      - **Dependencies/prerequisites:** P3-T1-ST1.
    ...
    - [x] **P3-T3-ST3 Define Group DM growth UX: convert-to-server flow and history continuity disclosure**
      - **Objective:** Provide a user-friendly, automatic path when a Group DM hits the cap without implying v0.7+ history-migration capabilities.
      - **Concrete actions:** Specify the conversion wizard: create server + initial channel, migrate member list, post a system notice explaining why the DM cannot grow further, and disclose history handling (default: history does not transfer; viewers keep local history).
      - **Dependencies/prerequisites:** P3-T3-ST2, v0.3/v0.4 roadmap awareness only (no v0.4 implementation implied).
      - **Deliverables/artifacts:** Convert-to-server UX contract and reason-code taxonomy for “history not transferable”.
      - **Acceptance criteria:** Conversion outcome is deterministic, self-explanatory to users, and never silently changes encryption posture.
      - **Suggested priority/order:** P1, Order 12.3.
      - **Risks/notes:** Poor conversion UX causes user churn during organic community growth moments.
...
- [x] **[P0][Order 13] P4-T1 Define friend identity exchange formats: public key, QR, deep link**
  - **Artifact references:** `docs/v0.2/phase4/p4-friend-graph-baseline.md`
  - **Objective:** Provide canonical friend discovery inputs across all entry paths.
  - **Concrete actions:**
    - [x] **P4-T1-ST1 Define canonical public-key sharing format and validation**
    ...
    - [x] **P4-T1-ST2 Define QR payload and `aether://` friend link payload schema**
...
- [x] **[P0][Order 14] P4-T2 Define friend request lifecycle protocol and trust semantics**
  - **Artifact references:** `docs/v0.2/phase4/p4-friend-graph-baseline.md`
  - **Objective:** Establish deterministic request state management from initiation to resolution.
  - **Concrete actions:**
    - [x] **P4-T2-ST1 Define request states: pending, accepted, declined, canceled, blocked**
    ...
    - [x] **P4-T2-ST2 Define request authenticity checks and anti-spoofing requirements**
...
- [x] **[P1][Order 15] P4-T3 Define friends list synchronization model and UI state contract**
  - **Artifact references:** `docs/v0.2/phase4/p4-friend-graph-baseline.md`
  - **Objective:** Deliver a stable friends list experience with online/offline/pending segmentation.
  - **Concrete actions:**
    - [x] **P4-T3-ST1 Define friends list data projections and tab segmentation rules**
    ...
    - [x] **P4-T3-ST2 Define UI states for loading, empty, error, and pending actions**
...
- [x] **[P0][Order 16] P5-T1 Define presence state machine and protocol schema**
  - **Artifact references:** `docs/v0.2/phase5/p5-presence-status-contract.md`
  - **Objective:** Formalize presence as protocol state, not UI-only state.
  - **Concrete actions:**
    - [x] **P5-T1-ST1 Define canonical presence states and transitions**
    ...
    - [x] **P5-T1-ST2 Define presence protobuf schema and capability negotiation flags**
...
- [x] **[P0][Order 17] P5-T2 Define presence dissemination, staleness, and convergence rules**
  - **Artifact references:** `docs/v0.2/phase5/p5-presence-status-contract.md`
  - **Objective:** Keep presence updates timely without creating noisy network traffic.
  - **Concrete actions:**
    - [x] **P5-T2-ST1 Define publish cadence, debounce, and throttle rules**
    ...
    - [x] **P5-T2-ST2 Define stale presence detection and offline fallback behavior**
...
- [x] **[P1][Order 18] P5-T3 Define custom status text behavior and policy bounds**
  - **Artifact references:** `docs/v0.2/phase5/p5-presence-status-contract.md`
  - **Objective:** Add expressive status text without compromising protocol simplicity or safety.
  - **Concrete actions:**
    - [x] **P5-T3-ST1 Define status text schema, length constraints, and encoding policy**
    ...
    - [x] **P5-T3-ST2 Define propagation, cache invalidation, and redaction behavior**
...
- [x] **[P0][Order 19] P6-T1 Define notification event model and unread counter rules**
  - **Artifact references:** `docs/v0.2/phase6/p6-attention-governance-baseline.md`
  - **Objective:** Deliver deterministic in-app attention signaling for v0.2 contexts.
  - **Concrete actions:**
    - [x] **P6-T1-ST1 Define notification event taxonomy across DM, Group DM, and server contexts**
      - **Objective:** Separate event categories for consistent handling and UI rendering.
      - **Concrete actions:** Specify event types, source metadata (including `security_mode` + `mode_epoch_id` where available), deep-link targets, and dedupe keys.
      - **Dependencies/prerequisites:** P2-T3, P3-T3, P4-T2.
      - **Deliverables/artifacts:** Notification event taxonomy specification.
      - **Acceptance criteria:** Each event type maps to one handling rule and one counter impact rule, and notification surfaces can display the correct security-mode badge for the target conversation.
      - **Suggested priority/order:** P0, Order 19.1.
      - **Risks/notes:** Event overlap can inflate unread counts.
    - [x] **P6-T1-ST2 Define unread counter increment/reset semantics per context**
...
- [x] **[P0][Order 20] P6-T2 Define mention parsing, tokenization, and resolution behavior**
  - **Artifact references:** `docs/v0.2/phase6/p6-attention-governance-baseline.md`
  - **Objective:** Standardize how mention tokens are recognized and resolved.
  - **Concrete actions:**
    - [x] **P6-T2-ST1 Define parser rules for `@user`, `@role`, `@everyone`, `@here`**
    ...
    - [x] **P6-T2-ST2 Define mention resolution order and unknown-target fallback behavior**
...
- [x] **[P1][Order 21] P6-T3 Define mention authorization and in-app notification surfaces**
  - **Artifact references:** `docs/v0.2/phase6/p6-attention-governance-baseline.md`
  - **Objective:** Prevent mass-mention abuse and present clear attention cues.
  - **Concrete actions:**
    - [x] **P6-T3-ST1 Define authorization checks for `@role`, `@everyone`, `@here` in v0.2**
    ...
    - [x] **P6-T3-ST2 Define badge and mention-highlight UI behavior by context**
...
- [x] **[P0][Order 21.5] P6-T4 Define baseline RBAC contract for Owner/Admin/Moderator/Member**
  - **Artifact references:** `docs/v0.2/phase6/p6-attention-governance-baseline.md`
  - **Objective:** Specify deterministic role hierarchy and permission boundaries required by v0.2 moderation/mention controls.
  - **Concrete actions:**
    - [x] **P6-T4-ST1 Define baseline role hierarchy and actor-target authority matrix**
    ...
    - [x] **P6-T4-ST2 Define role-resolution behavior for reconnect/stale-state conditions**
...
- [x] **[P0][Order 21.6] P6-T5 Define baseline moderation protocol events and slow-mode enforcement semantics**
  - **Artifact references:** `docs/v0.2/phase6/p6-attention-governance-baseline.md`
  ...
  - **Concrete actions:**
    - [x] **P6-T5-ST1 Define signed moderation-event schema and decentralized enforcement requirements**
    ...
    - [x] **P6-T5-ST2 Define channel slow-mode timing semantics and replay/rejoin behavior**
...
- [x] **[P0][Order 22] P7-T1 Define v0.2 end-to-end scenario validation pack (planning package)**
  - **Artifact references:** `docs/v0.2/phase7/p7-t1-e2e-scenario-pack.md`
  - **Objective:** Verify core user journeys across all v0.2 capabilities.
  - **Concrete actions:**
    - [x] **P7-T1-ST1 Build scenario pack for DM, Group DM, friends, presence, notifications, mentions, baseline RBAC, moderation, and slow mode**
    ...
    - [x] **P7-T1-ST2 Define failure-recovery scenarios and expected user-visible behavior**
...
- [x] **[P0][Order 23] P7-T2 Define compatibility, governance, and unresolved-decision conformance review package**
  - **Artifact references:** `docs/v0.2/phase7/p7-t2-conformance-review.md`
  - **Objective:** Confirm v0.2 plan outputs preserve all architectural guardrails.
  - **Concrete actions:**
    - [x] **P7-T2-ST1 Audit protobuf and protocol changes for additive/major-version compliance**
    ...
    - [x] **P7-T2-ST2 Validate governance constraints and open-decision posture**
...
- [x] **[P1][Order 24] P7-T3 Define v0.2 release gate package and v0.3 handoff backlog (planning package)**
  - **Artifact references:** `docs/v0.2/phase7/p7-t3-release-gate-handoff.md`
  - **Objective:** Close v0.2 planning/execution loop with clear completion and forward handoff.
  - **Concrete actions:**
    - [x] **P7-T3-ST1 Assemble release gate checklist with traceable evidence links**
    ...
    - [x] **P7-T3-ST2 Create v0.3+ deferral and carry-forward backlog from v0.2 residuals**
