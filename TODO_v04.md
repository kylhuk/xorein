...
- Sprint model rule: one sprint maps to one minor version planning band and this document stays scoped to v0.4.
...
7. Channel security modes + disclosure + auditable mode transitions (Tree/Crowd/Channel/Clear)

No additional capability outside these seven bullets is promoted into v0.4 in this plan.
