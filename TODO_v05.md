...
- [x] **[P0][Order 07] P1-T4 Define bot authentication authorization and audit boundary integration**
  ...
  - **Concrete actions:**
    ...
    - [x] **P1-T4-ST3 Define bot trust classes and SecurityMode gating rules (default: Clear-only plaintext)**
      ...
      - **Deliverables/artifacts:** Bot SecurityMode gating policy and reason taxonomy.
      - **Acceptance criteria:** Bots never receive plaintext from E2EE conversations by default; any exception requires explicit opt-in semantics and auditability hooks.
      - **Suggested priority/order:** P0, Order 07.3.
      - **Risks/notes:** Bot integrations are a high-risk confidentiality boundary without explicit gating.
